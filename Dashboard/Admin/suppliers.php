    ...
    font-size: 0.8rem;
      ...
      <div class="tab-nav">
        ...
        <div>
          ...
          <button class="btn btn-primary"><i class="bi bi-plus-circle"></i> <span id="actionLabel">New
              Order</span></button>
        </div>
      </div>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <tr>
              ...
              <td class="table-actions"><i class="bi bi-eye"></i><i class="bi bi-pencil"></i><i
                  class="bi bi-printer"></i><i class="bi bi-download"></i><i class="bi bi-three-dots"></i></td>
            </tr>
            <tr>
              <td>PO-2025-002</td>
