...
<div class="row mt-4">
  ...
  <div class="col-md-6">
    <div class="card p-3" style="height: 300px;">
      <h6>Online Sales</h6>
      <canvas id="onlineSalesChart" style="height: 100% !important;"></canvas>
    </div>
  </div>
  ...
  <div class="col-md-6">
    <div class="card p-3" style="height: 300px;">
      <h6>Retail Sales</h6>
      <canvas id="retailSalesChart" style="height: 100% !important;"></canvas>
    </div>
  </div>
</div>
...
new Chart(pieCtx, {
  ...
  data: {
    ...
    datasets: [{
      data: [35, 23, 18, 16, 8],
      backgroundColor: ['#0d6efd', '#20c997', '#ffc107', '#fd7e14', '#6f42c1']
    }]
  },
  options: {
    responsive: true,
    maintainAspectRatio: false, // Ensure chart adjusts to container size
    plugins: {
      legend: {
        position: 'bottom',
        labels: {
