...
<div class="row justify-content-center">
    <div class="col-md-3 col-sm-6 mb-4">
        <button type="button" class="btn btn-outline-primary btn-lg w-100" data-bs-toggle="modal"
            data-bs-target="#addExpense"><i class="fa-solid fa-plus"></i> Add New Expenses</button>
    </div>
    <div class="col-md-3 col-sm-6 mb-4">
        <button type="button" class="btn btn-outline-primary btn-lg w-100"><i class="fa-regular fa-file-word"></i> Scan
            Receipt</button>
    </div>
    <div class="col-md-3 col-sm-6 mb-4">
        <button type="button" class="btn btn-outline-primary btn-lg w-100" data-bs-toggle="modal"
            data-bs-target="#createReportModal"><i class="fa-solid fa-file-lines"></i>
            Generate Report</button>
    </div>
    <div class="col-md-3 col-sm-6 mb-4">
        <button type="button" class="btn btn-outline-primary btn-lg w-100"><i class="fa-solid fa-chart-column"></i> View
            Analysis</button>
    </div>
</div>
            ...
            <div class="modal-body">
                ...
                <div class="mt-3">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="cancelledTransactions">Include Cancelled
                            Transactions</label>
                    </div>
                    <div class="form-check">
