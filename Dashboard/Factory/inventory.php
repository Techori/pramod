...
<div>
    ...
    <div class="container-fluid d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="justify-contnt-end">
            ...
            <button class="btn btn-primary" type="submit">New Shipment</button>
        </div>
    </div>
  ...
  <div class="card p-4 shadow-sm">
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <div class="d-flex gap-2">
        <button class="btn btn-outline-secondary btn-sm" onclick="refreshTable()"> Refresh</button>
        <button class="btn btn-outline-secondary btn-sm" onclick="sortTable()"> Sort</button>
      </div>
    </div>
