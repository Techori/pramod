    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <div class="d-flex flex-column flex-sm-row gap-2 align-items-center">
            <div class="input-group w-auto flex-grow-1" style="max-width: 300px;">
                ...
                <input type="text" class="form-control border-start-0" placeholder="Search reports..." id="reportSearch" oninput="filterReports()">
            </div>
            <select class="form-select w-auto" style="max-width: 180px;" id="periodSelect" onchange="updateCharts()">
            ...
            <button class="btn btn-outline-primary btn-sm" title="Calendar"><i class="fas fa-calendar-alt"></i></button>
            <button class="btn btn-outline-primary btn-sm" title="Filter"><i class="fas fa-filter"></i></button>
        </div>
        <div class="d-flex gap-2 flex-wrap">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="#" onclick="alert('Printing report...')"><i class="fas fa-print me-2"></i> Print</a></li>
                </ul>
            </div>
        ...
        <div class="row">
            ...
            ?>
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card stat-card cards shadow-sm report-card" data-report-name="<?php echo htmlspecialchars($report['name']); ?>">
                        <div class="card-body d-flex align-items-start">
                            <div class="p-2 rounded bg-light me-3">
                                <i class="fas <?php echo htmlspecialchars($report['icon']); ?> text-<?php echo htmlspecialchars($report['color']); ?>"></i>
                            </div>
                            <div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="report-row" data-report-name="<?php echo htmlspecialchars($report['name']); ?>">
                                                <td><?php echo htmlspecialchars($report['name']); ?></td>
                                                <td><?php echo htmlspecialchars($report['date']); ?></td>
                                                <td><?php echo htmlspecialchars($report['type']); ?></td>
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <button class="btn btn-outline-primary btn-sm" onclick="viewReport('<?php echo htmlspecialchars($report['name']); ?>')">
                                                            <i class="fas fa-eye"></i>
                                                        </button>
                                                        <button class="btn btn-outline-primary btn-sm" onclick="exportReport('Excel', '<?php echo htmlspecialchars($report['name']); ?>')">
