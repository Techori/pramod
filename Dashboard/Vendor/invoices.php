            ...
            <div class="d-flex flex-column gap-3">
                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <a href="?page=invoices&status=<?php echo urlencode($status); ?>&type=<?php echo urlencode($type_filter); ?>&search=<?php echo urlencode($search_query); ?>">
                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <a href="?page=invoices&status=<?php echo urlencode($status_filter); ?>&type=<?php echo urlencode($type); ?>&search=<?php echo urlencode($search_query); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if ($invoice['type'] === 'GST'): ?>
                                    <div class="small text-muted">GST: <?php echo htmlspecialchars($invoice['gstNumber']); ?></div>
                                <?php endif; ?>
                            </td>
                            <td>
...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
            <div class="col">
                <button type="button" class="btn btn-outline-primary btn-sm w-100 h-100 py-3 d-flex flex-column align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#generateInvoiceModal">
            ...
            <div class="col">
                <form method="POST" action="?page=invoices">
                    ...
                    <button type="submit" class="btn btn-outline-success btn-sm w-100 h-100 py-3 d-flex flex-column align-items-center gap-2">
            ...
            <div class="col">
                <form method="POST" action="?page=invoices">
                    ...
                    <button type="submit" class="btn btn-outline-purple btn-sm w-100 h-100 py-3 d-flex flex-column align-items-center gap-2">
            ...
            <div class="col">
                <form method="POST" action="?page=invoices">
                    ...
                    <button type="submit" class="btn btn-outline-warning btn-sm w-100 h-100 py-3 d-flex flex-column align-items-center gap-2">
            ...
            <form method="POST" action="?page=invoices">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="gstNumber" id="gstNumber" class="form-control" placeholder="e.g., 29ABCDE1234F1Z5">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="dueDate" id="dueDate" class="form-control" value="<?php echo $default_due_date; ?>" required>
                    </div>
                </div>
